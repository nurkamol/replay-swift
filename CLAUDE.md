...
swift test                      # 951 parity checks + 90 behaviour cases
...
node tools/release-notes.mjs 0.9.0 --check   # the tag, the build and the changelog agree
```
...
Glaze app — 951 checks. **The UI is largely built**: an application menu, a menu bar item,
